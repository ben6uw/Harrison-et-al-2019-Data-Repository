...
setwd("/Users/ben/Google Drive/Documents/BlueFeedingAssay")
dir()
...
par(mfrow=c(5,2))
plot(X300 ~ number.of.flies, data=blue, pch=19)
plot(X300.1 ~ number.of.flies, data=blue, pch=19)
plot(X400 ~ number.of.flies, data=blue, pch=19)
plot(X400.1 ~ number.of.flies, data=blue, pch=19)
plot(X500 ~ number.of.flies, data=blue, pch=19)
plot(X500.1 ~ number.of.flies, data=blue, pch=19)
plot(X600 ~ number.of.flies, data=blue, pch=19)
plot(X600.1 ~ number.of.flies, data=blue, pch=19)
plot(X700 ~ number.of.flies, data=blue, pch=19)
plot(X700.1 ~ number.of.flies, data=blue, pch=19)

plot(X690 ~ number.of.flies, data=blue, pch=19)
lm(blue$X690 ~ blue$number.of.flies) -> fit690.flies
summary(fit690.flies)

plot(X690.1 ~ number.of.flies, data=blue, pch=19)
lm(blue$X690.1 ~ blue$number.of.flies) -> fit690.1.flies
summary(fit690.1.flies)
### it looks like dividing the abs by the number of flies did not result in the correction that I would have expected, where the new Abs values (ie. 690.1) would have no relationship with number.of.flies   Instead, there appears to be no relationship PRIOR to correction and a sig relationship AFTER correction.

hist(log(blue$X690), breaks=10)
hist(log(blue$X690.1), breaks=10)
# log normalization may be good

names(blue)
par(mfrow=c(3,2))

plot(X300 ~ treatment, data=blue, pch=19)
plot(X400 ~ treatment, data=blue, pch=19)
plot(X500 ~ treatment, data=blue, pch=19)
plot(X600 ~ treatment, data=blue, pch=19)
plot(X700 ~ treatment, data=blue, pch=19)

plot(X630 ~ treatment, data=blue, pch=19)
plot(X630 ~ time.without.dye, data=blue, pch=19)
...
blue[blue$line == 'RAL_239', ] -> ral239
ral239[ral239$time.on.dye == 2, ] -> ral239.2
ral239.2[ral239.2$number.of.flies > 5, ] -> ral239.3
plot(ral239$X630 ~ ral239$number.of.flies, pch=19)
plot(ral239.2$X630 ~ ral239.2$number.of.flies, pch=19)
plot(ral239.3$X630.1 ~ ral239.3$number.of.flies, pch=19)

plot(ral239.3$X630.1 ~ ral239.3$time.without.dye, lwd=2, col=ral239.3$treatment, pch="-", cex=4)
points(ral239.3$X630.1 ~ ral239.3$time.without.dye, pch=19, col=ral239.3$treatment)




i = 'RAL_320'
blue[blue$line == i, ] -> temp
temp[temp$time.on.dye == 2, ] -> temp.2
temp.2[temp.2$number.of.flies > 5, ] -> temp.3
par(mfrow=c(2,2))
plot(temp$X630 ~ temp$number.of.flies, pch=19)
plot(temp.2$X630 ~ temp.2$number.of.flies, pch=19)
plot(temp.3$X630.1 ~ temp.3$number.of.flies, pch=19)

plot(temp.3$X630.1 ~ temp.3$time.without.dye, lwd=2, col=temp.3$treatment, pch="-", cex=4)
...
head(simp)
str(simp)
levels(simp$line.time.treatment) 
...
levels(temp$line.time.treatment)
